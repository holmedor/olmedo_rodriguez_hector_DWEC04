...
var desde = 0;
const intervalo = 10;
var urlgraf = "https://api.euskadi.eus/udalmap/indicators/103?lang=SPANISH";
var urldatos = "https://api.euskadi.eus/udalmap/indicators/103/regions";
...
//            console.log(`${property}: ${valores[property]}`);
        ...
        $("#taxis").append('<div id="titulo">'+element.name+
...
////////////////////////////////////////////////////// handleButtonClick
    ...
    urldatos = "https://api.euskadi.eus/udalmap/indicators/103/regions/" + buttonName;
    pedirDatos(urldatos)
        .then(function (data) {
            //JS
            ...
            datos = data;
            console.log(datos);
            pintarGraficoComarcaTaxis(data);
        })
        .catch(function (err) {
            //JS
...
////////////////////////////////////////////////////// pintarGraficoComarcaTaxis
function pintarGraficoComarcaTaxis(data) {
        var newWindowTaxis = window.open('', 'Gráfico comarca', 'width=400, height=300');
        newWindowTaxis.document.write('<html><head><title>Gráfico comarca</title></head><body><h1 id="titulo"></h1><div id="aqui"></div></body></html>');
    var mylabels = [];
    var myvalues = [];
    ...
    newWindowTaxis.document.getElementById("titulo").innerHTML = 'Total de licencias de taxi por cada 10000 habitantes de la comarca';
    newWindowTaxis.document.getElementById("aqui").innerHTML = '';
    var ctx = document.createElement('canvas');
    ctx.width = 200;
    ctx.height = 100;
    newWindowTaxis.document.getElementById("aqui").appendChild(ctx);
