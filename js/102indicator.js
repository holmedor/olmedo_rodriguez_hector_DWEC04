...
var desde = 0;
const intervalo = 10;
var urlgraf = "https://api.euskadi.eus/udalmap/indicators/102?lang=SPANISH";
var urldatos = "https://api.euskadi.eus/udalmap/indicators/102/regions";
...
//        console.log("element.years: ", element.years);
        ...
        $("#vehiculos").append('<div id="titulo">'+element.name+
...
////////////////////////////////////////////////////// handleButtonClick
    ...
    urldatos = "https://api.euskadi.eus/udalmap/indicators/102/regions/" + buttonName;
    pedirDatos(urldatos)
        .then(function (data) {
            //JS
            ...
            datos = data;
            console.log(datos);
            pintarGraficoComarcaVehiculos(data);
        })
        .catch(function (err) {
            //JS
...
////////////////////////////////////////////////////// pintarGraficoComarcaVehiculos
function pintarGraficoComarcaVehiculos(data) {
        var newWindowVehiculos = window.open('', 'Gráfico comarca', 'width=400, height=300');
        newWindowVehiculos.document.write('<html><head><title>Gráfico comarca</title></head><body><h1 id="titulo"></h1><div id="aqui"></div></body></html>');
    var mylabels = [];
    var myvalues = [];
    ...
    newWindowVehiculos.document.getElementById("titulo").innerHTML = 'Total de vehículos entre el total de habitantes de la comarca';
    newWindowVehiculos.document.getElementById("aqui").innerHTML = '';
    var ctx = document.createElement('canvas');
    ctx.width = 200;
    ctx.height = 100;
    newWindowVehiculos.document.getElementById("aqui").appendChild(ctx);
